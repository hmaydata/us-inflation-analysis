# U.S. Inflation Dynamics Analysis (R + Power BI + FRED Data)
...
- Inflation trends (CPI, PCE, core measures)  
- Energy prices and supply shocks  
- Wage growth vs productivity (demand pressure)  
- Yield curve (market expectations)  

📊 [Download Power BI Dashboard (.pbix)](dashboard/inflation_dashboard.pbix)
...
- Wage growth is converging toward productivity, suggesting emerging demand-side pressure  
